...
function update_all() {
    ...
    success:
        function(out) {
            humidityValue.attr('class', 'count');
            humidityValue.html(out['humidity'].value);
            humidityTime.html('Last Updated: ' + out['humidity'].time);
            brightValue.attr('class', 'count');
            brightValue.html(out['brightness'].value);
            brightTime.html('Last Updated: ' + out['brightness'].time);
            temperatureValue.attr('class', 'count');
            temperatureValue.html(out['temperature'].value + '°');
            temperatureTime.html('Last Updated: ' + out['temperature'].time);
            create_table()
        }})
}
